...
import static org.orion.koffe.TestUtil.readListFromJsonMvcResult;
...
public class TestMatcher<T> {
    ...
    public static <T> TestMatcher<T> usingFieldsWithIgnoringAssertions(Class<T> clazz, String... fieldsToIgnore) {
        return usingAssertions(clazz,
                ...
                (Iterable<T> a, Iterable<T> e) -> {
                    IterableAssert<T> tIterableAssert = assertThat(a);
                    tIterableAssert.usingElementComparatorIgnoringFields(fieldsToIgnore);
                    tIterableAssert.isEqualTo(e);
                });
    }
